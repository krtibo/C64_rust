...
pub fn dec(opc: &mut Opcode, cpu: &mut MOS6510, operand: u8, address: u16) {
...
pub fn inc(opc: &mut Opcode, cpu: &mut MOS6510, operand: u8, address: u16) {
